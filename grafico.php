...
$(function () {
    $(document).ready(function() {
        ...
        $('#container').highcharts({
            ...
            title: {
                text: 'Grafico Humedad, Temperatura y Concentración de Polvo'
            },
            xAxis: {
                type: 'datetime',
            ...
            series: [{
                ...
                data: (function() {
                   var data = [];
                    <?php
                        for($i = 0 ;$i<count($rawdata);$i++){
                    ?>
                    data.push([<?php echo $rawdata[$i]["tiempo"];?>,<?php echo $rawdata[$i]["temperatura"];?>]);
                    <?php } ?>
                return data;
                })()
            },{
                name: 'humedad',
                    ...
                    <?php
                        for($i = 0 ;$i<count($rawdata);$i++){
                    ?>
                    data.push([<?php echo $rawdata[$i]["tiempo"];?>,<?php echo $rawdata[$i]["humedad"];?>]);
                    <?php } ?>
                return data;
                     })() 
            },{
